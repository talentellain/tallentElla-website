    ...
    <>
      <div id="services" ref={outerRef} className="sticky-outer" style={{ zIndex: 20 }}>
        <motion.section
          ...
          style={{ backgroundColor: '#0a0a0c', borderTopLeftRadius: borderRad, borderTopRightRadius: borderRad, borderTop: '1px solid rgba(255,255,255,0.06)', justifyContent: 'flex-start' }}
        >
          <div style={{ width: '100%', height: '100%', overflowY: 'auto', padding: '12vh 2% 8vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className="services-header" style={{ marginBottom: '4vh', maxWidth: '800px', textAlign: 'center', padding: '0 5%' }}>
              ...
              <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} style={{ color: '#888888', fontSize: 'clamp(0.75rem, 2vw, 1rem)', lineHeight: '1.4', fontWeight: 500, marginTop: '0.5rem', maxWidth: '600px', margin: '0.5rem auto 0' }}>
                Full-service 360° marketing solutions — brand development, social media marketing, and integrated digital strategies to scale your presence across India.
              </motion.p>
            </div>
